...
$$sg1-P_{\theta}(p|u)$$.
$$sg$$ is the stop-gradient operator and $P_{\theta}(p|u))$ is the current estimation of the relavancy of item $p$ given the user $u$ which is calculated using importance sampling:
